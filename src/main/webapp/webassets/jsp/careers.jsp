...
<head>
   ...
   <link rel="apple-touch-icon" sizes="57x57" href="/webassets/PTicons/apple-icon-57x57.png">
	...
	<meta property="og:title" content="Careers | Online Free Appointment Scheduling Software | Booking Software  | Calendar Management System | Picktime"></meta>
...
<body>
	...
	<div class="container-fluid careers-container">
		<h2>Want to be part of our amazing team?</h2>
		<div class="container">
			<div class="careers-container-text">Send in your resumes to hello@picktime.com</div>
			<!-- <div class="col-md-12 col-sm-12  careers-links">
				<p><a href="javascript:void(0);">Vacancies</a></p>
				<p><a href="javascript:void(0);">Growth Hacker</a></p>
				<p><a href="/careers">Frontend Developer</a></p>
				<p><a href="javascript:void(0);">Designer</a></p>
			</div> -->
			<div class="col-md-12 col-sm-12 ">
			  <ul class="careers-links">
		      	 <li class="active"><a href="javascript:void(0);">Vacancies</a></li>	     
		         <li class=""><a href="javascript:void(0);">Growth Hacker</a></li>	
		         <li class=""><a href="javascript:void(0);">Frontend Developer</a></li>	
		         <li class=""><a href="javascript:void(0);">Designer</a></li>
		      </ul>
			</div>
		</div>
	</div>
