	...
	<body>
		...
		<div class="col-md-12">
			<div class="row error-main-container">
				<div class="col-sm-6">
					<h1>Uh-Oh!</h1>
					<h2>Something went wrong in the server.</h2>
		...
		<div class="error-footer-container">
			<a class="error-footer-container-link"  href="mailto:hello@picktime.com?subject=500-Something went wrong in the server">
