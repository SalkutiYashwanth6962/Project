...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>Picktime.com | Online Free Appointment Scheduling Software | Booking Software  | Reviews</title>
...
<body>
	...
	<script>
		...
		logo_theme.src = '/webassets/images/picktime-theme.png';
		var logo_trans = new Image();
		logo_trans.src = '/webassets/images/picktime-trans.png';
		var logo_mini = new Image();
		logo_mini.src = '/webassets/images/picktime-logo-128.png';
