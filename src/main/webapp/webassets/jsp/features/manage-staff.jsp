...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>Picktime.com | Online Free Appointment Scheduling Software | Booking Software  | Manage Staff</title>
...
<body>
	...
	<div class="container-fluid  featuresPage-body section">
		<div class="row">
			...
			<div class="col-md-12 col-sm-12">
				<p>Automatically generate reports. Know which staff has provided the best service for that particular week or month. This not only gives you better insights about your staff but also helps your reward them anyway possible. You can also add unlimited staff to your account for no added cost.  
				What are you still waiting for? join on board for free.</p>
			</div>
		</div>
	</div>
