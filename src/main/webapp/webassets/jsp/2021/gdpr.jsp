...
<div id="gdpr" style="margin: 120px 0px 250px 0px;">
	<div class="container">
        ...
        <div class="col-md-12">
            <div class="media">
              <div class="media-left">
                <i class="icon-rating" aria-hidden="true" style="font-size: 25px;"></i>
              </div>
  ...
  <div class="row">
     ...
     <p>The following are some frequently asked questions about the changes in the terms and conditions of use of Picktime and the responsibilities and liabilities of the Picktime users as well as the owner.
     </p>
     <h3>How to ensure safe registration at Picktime?
     </h3>
     ...
     <h3>How to terminate my account?
     </h3>
     <p>In case a user wishes to terminate their account and stop using a service, they can seek help from the tools provided for account termination on our website or they may directly contact the owner.
     </p>
     
     <h3>What if my personal data is disclosed?
     </h3>
...
In case you have a query or wish to complain against a privacy breach, email us at legal@picktime.com.
     ...
     <h3>Do I need to sign a Data Processing Addendum (DPA) with Picktime?
     </h3>
     ...
     <h3>Does using Picktime make me comply with the GDPR?
     </h3>
