				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="select">
							...
							<select class="drop">
								<option class="options" value="1">Select country</option>
								<option class="options" value="2">IND</option>
								<option class="options" value="3">UK</option>
								<option class="options" value="3">US</option>
								<option class="options" value="3">AS</option>
							</select>
						</div>
