			...
			<div class="container mt-20">
				<div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="/">
                    	<img src="/webassets/2021/img/pt-santa/pt-hat-1.svg" alt="Picktime Logo">
                    	<img src="/webassets/2021/img/pt-santa/santa-dance.gif" style="width: 50px;position: absolute;margin-left: 178px;margin-top: -55px;">
                    </a>
				</div>
