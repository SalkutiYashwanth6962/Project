...
<section id="industries_services">
		...
		<!-- <div class="col-md-6"><img src="/webassets/2021/img/coaching.jpeg" class="img-circle" alt="coaching" style="height: 400px; width: 80%;margin-top: 30px; margin-left: 20px; border: solid 10px #8A2BE2;"> </div>
		<div class="col-md-6"><div class="main_title" style="color:#8B22E2;"><h1>Coaching Scheduling Software</h1></div></div>
		 -->
		
		
		
			<div class="main_title" style="color:#8B22E2;"><h1>Coaching Scheduling Software</h1></div> 
