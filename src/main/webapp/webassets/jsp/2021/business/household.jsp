...
<head>
    ...
    <meta property="og:title" content="Household Appointment Scheduling Software| Online Free Appointment Scheduling Software | Booking Software  | Calendar Management System | Picktime"></meta>
	<meta property="og:type" content="website" />
	<meta property="og:image" content="https://www.picktime.com/webassets/2021/img/business/cover-img/household-cover.png" />
	<meta property="og:image:alt" content="Household Appointment Scheduling Software " />
	<meta property="og:url" content="https://www.picktime.com" />
	<meta property="og:description" content="No more calls! Behold an online appointment scheduling software for simplifying household services bookings. Enable customers to self-book appointments with payments & invoicing." />
    <!-- for Twitter -->          
	<meta name="twitter:card" content="summary" />
	<meta name="twitter:title" content="Household Appointment Scheduling Software | Online Free Appointment Scheduling Software | Booking Software  | Calendar Management System | Picktime" />
	<meta name="twitter:description" content="No more calls! Behold an online appointment scheduling software for simplifying household services bookings. Enable customers to self-book appointments with payments & invoicing." />
	<meta name="twitter:image" content="https://www.picktime.com/webassets/2021/img/business/cover-img/household-cover.png" />
...
<body>
	...
	<section class="sec-first">
 		<div class="container">
			<div class="col-md-6 ">
				<h1>Online appointment scheduling solution for your<span> household </span>needs</h1>
				<p>No more calls! Behold an online appointment scheduling software for simplifying household services bookings. Enable customers to self-book appointments with payments & invoicing.</p>
				<a href="/register"><button class="btn-lg text-center">GET STARTED</button></a>
			</div>
			<div class="col-md-6">
		    	<img alt="home services scheduling software" src="/webassets/2021/img/business/household-hero.svg">
			</div>
	 	</div>
	</section>
	...
	<div class="sec-three">
		<div class="container">
			<div class="col-md-6 text-container">
				...
				<h4 class="aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">Customize the booking experience</h4>
	...
	<div class="sec-four">
		<div class="container">
			<div class="col-md-6 hidden-xs hidden-sm">
		   		<img alt="manage all your clients" src="/webassets/2021/img/business/household-customer-management.svg" class="aos-init aos-animate" data-aos="fade-up" data-aos-delay="100" style="margin-top: 35px;">
			</div>
			<div class="col-md-6 text-container">
				<h3 class="aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">CUSTOMER MANAGEMENT</h3>
				<h4 class="aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">Get an all-in-one Customer management system</h4>
            	<p class="aos-init aos-animate" data-aos="fade-up" data-aos-delay="300">Handle each customer with care. Add them to the admin account, securely save the customer information and booking data. Remind them about their appointments, accept payments & send them invoices.</p>
			</div>
			<div class="col-md-6 hidden-md hidden-lg" style="margin-top: 50px;">
	   			<img alt="manage all your clients" src="/webassets/2021/img/business/household-customer-management.svg" class="aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
			</div>
		</div>
	</div>
	<div class="sec-five">
		<div class="container">
			<div class="col-md-6 text-container">
				...
				<h4 class="aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">Keep customers in the loop with automated reminders</h4>
				<p class="aos-init aos-animate" data-aos="fade-up" data-aos-delay="300">Ensure that you avoid missing appointments. Inform your staff and customers about their scheduled appointments with automated reminders via SMS and email.</p>
			</div>
			<div class="col-md-6">
  				<img alt="automatic client reminders" src="/webassets/2021/img/business/beauty-salon-reminders.svg" class="aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
    		</div>
		</div>
	</div>
