...
<body>
	...
	<section class="sec-first">
 		<div class="container">
			...
			<div class="col-md-6">
	    		<img alt="hair salon appointment Scheduling Software" src="/webassets/2021/img/business/hair-salon-hero.svg">
			</div>
 		</div>
	</section>
		...
		<div class="container text-center">
			<div class="col-md-4 col-lg-4">
				<div class="colums aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
	        		<div class="i-img text-center"> <img alt="hair salon appointment Email Notifications" src="/webassets/2021/img/icons/features/Notifications_icon.svg"> </div>
		       		<h3>Email Notifications</h3>
		       		<p>Send automated Booking Notifications through email to your Customers and Team</p>
			    </div> 	
			</div>
			<div class="col-md-4 col-lg-4">
				<div class="colums aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
	       			<div class="i-img"> <img alt="hair salon appointment Payments " src="/webassets/2021/img/icons/features/Take-payments_icon.svg"> </div>
		       		<h3>Payments</h3>
		       		<p>Take 24x7 online payments from customers while booking appointments</p>
	      		</div> 	
			</div>
			<div class="col-md-4 col-lg-4">
		    	<div class="colums aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
      				<div class="i-img"> <img alt="Booking Widget" src="/webassets/2021/img/icons/features/Booking-Widget_icon.svg"> </div>
	       			<h3>Booking Widget</h3>
	       			<p>Embed “Book Now” button and take online bookings directly from your website</p>
		       	</div>
			</div>
	...
	<div class="sec-three">
		<div class="container">
			<div class="col-md-6 text-container">
				...
				<h4 class="aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">Ease customer bookings</h4>
				<p class="aos-init aos-animate" data-aos="fade-up" data-aos-delay="300">Create and personalize an online booking page that allows customers to book appointments securely at any time. You may include this online booking page on your website.</p>
			</div>
			<div class="col-md-6">
				<img alt="Online Booking page for your hair salon" src="/webassets/2021/img/business/hair-salon-online-bookings.svg" class="aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
    		</div>
		</div>
	</div>
	<div class="sec-four">
		<div class="container">
			<div class="col-md-6 hidden-xs hidden-sm">
	   			<img alt="Manage your multiple hair salons" src="/webassets/2021/img/business/hair-salon-multiple-location-management.svg" class="aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
			</div>
			<div class="col-md-6 text-container">
				<h3 class="aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">MULTIPLE LOCATION MANAGEMENT</h3>
				<h4 class="aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">Streamline Administration</h4>
           		<p class="aos-init aos-animate" data-aos="fade-up" data-aos-delay="300">Manage customer bookings across your multiple office locations. Monitor the working schedule of team members in all your office locations and allocate resources to them.</p>
			</div>
