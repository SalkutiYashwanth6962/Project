...
<body>
	...
	<section class="sec-first">
 		<div class="container">
			<div class="col-md-6 ">
				<h1>Online Appointment Scheduling Software for <span> Embassies & Consulates</span></h1>
				<p>A free 24/7 appointment scheduling software for embassies and consulates to serve the people better. Includes meeting reminders, fee payment, invoicing & staff management.</p>
				<a href="/register"><button class="btn-lg text-center">GET STARTED</button></a>
			</div>
			<div class="col-md-6">
		    	<img alt="Online Embassies and Consulates  appointment scheduling software" src="/webassets/2021/img/business/embassies-consulates-hero.svg">
			</div>
	 	</div>
	</section>
	...
	<div class="sec-three">
		<div class="container">
			<div class="col-md-6 text-container">
				...
				<h4 class="aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">Allow self-booking appointments for citizens</h4>
	...
	<div class="sec-four">
		<div class="container">
			...
			<div class="col-md-6 text-container">
				...
				<h4 class="aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">Serve citizens via virtual Zoom/Google Meet appointments</h4>
	...
	<div class="sec-five">
		<div class="container">
			<div class="col-md-6 text-container">
				...
				<h4 class="aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">Notify citizens with automated meeting alerts</h4>
