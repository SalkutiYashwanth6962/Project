...
<body>
	...
	<section class="sec-first">
 		<div class="container">
			<div class="col-md-6 ">
				<h1>aaaaa <span>teaching </span> Scheduling Software</h1>
			...
			<div class="col-md-6">
		    	<img alt="Online doctor appointment scheduling software" src="/webassets/2021/img/business/teaching-hero.svg">
			</div>
	 	</div>
	</section>
