...
<head>
    ...
    <link href="https://www.picktime.com/css/bootstrap.min.css?_=v21621v1" rel="stylesheet">
    <link href="https://www.picktime.com/css/app-v2/error.css?_=v21621v1" rel="stylesheet">
</head>
	<body>
		<div class="error-header">
			<a href="/"><img src="https://www.picktime.com/img/picktime-logo-main.svg" alt="Picktime Logo"></a>
		</div>
		<div class="col-md-12">
			<div class="row error-main-container">
				<div class="col-sm-6 error-main">
					<h1>Oops!</h1>
					<h2>We could not find what we are looking for.</h2>
					<a href="/" class="btn btn-primary back-btn">GO BACK</a>
				</div>
				<div class="col-sm-6">
					<img src="https://www.picktime.com/img/404.svg" class="error-image" alt="Picktime Page Not Found">
				</div>
			</div>	
		</div>
		...
		<div class="col-md-4 error-footer">
			<div class="footer-column">
				<a class="error-footer-container-link" href="/register">
			  		<div class="desc-img pull-left">
			      		<img src="https://www.picktime.com/img/create-business.svg" alt="create a business">
			  		</div>
			  		<div class="img-desc-block clearfix">
		...
		<div class="col-md-4 error-footer">
			<div class="footer-column">
				<a class="error-footer-container-link" href="/faqs">
			  		<div class="desc-img pull-left">
			      		<img src="https://www.picktime.com/img/have-a-question.svg" alt="question">
			  		</div>
			  		<div class="img-desc-block clearfix">
