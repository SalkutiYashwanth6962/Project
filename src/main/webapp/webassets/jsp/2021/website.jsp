	...
	<section class="onlinebooking">
		<div class="container-fluid" style="overflow: hidden;">
			<div class="container">
				...
				<div class="col-md-6">
					<div class="bg1">
						<img src="/webassets/2021/img/Online-booking-bg.svg" alt="Picktime-Public-Online-Booking-Page-Background" class="bg-o">
						<img src="/webassets/2021/img/Online-booking-img.svg" alt="Picktime-Public-Online-Booking-Page" class="img-o" data-aos="zoom-in-left">
					</div>
				</div>
			</div>
		</div>
   ...
   <!----------Payment and invoicing----------->
	<section class="payment">
		<div class="container-fluid" style="overflow: hidden;">
			<div class="container">
				<div class="col-md-6">
					<div class="bg2">
						<img src="/webassets/2021/img/Payment-and-invoicing-bg.svg" alt="Accept-Payments-PayPal-Stripe-Square-Background" class="bg-p"> 
						<img src="/webassets/2021/img/payment_and_invoicing.svg" alt="Accept-Payments-PayPal-Stripe-Square" class="img-p">
					</div>
				</div>
				<div class="col-md-6">
	...
	<section class="video">
		<div class="container">
			...
			<div class="col-md-6">
				<div class="bg2">
					<img src="/webassets/2021/img/Video-meeting-integration-img.svg" alt="Schedule-Online-Classes-Zoom-GoogleMeet-GOTOMeeting" class="img-v">
				</div>
			</div>
		</div>
	</section>
	...
	<section class="multiple">
		<div class="container-fluid" style="overflow: hidden;">
			<div class="container">
				<div class="col-md-6">
					<div class="bg2">
						<img src="/webassets/2021/img/Multiple-location-managment-bg.svg" class="bg-m" alt="Manage-Multiple-Business-Location-Background" > 
						<img src="/webassets/2021/img/multiple-location.svg" alt="Manage-Multiple-Business-Location" class="img-m">
					</div>
				</div>
				<div class="col-md-6">
	...
	<section class="reminders">
		<div class="container-fluid" style="overflow: hidden;">
			<div class="container">
				...
				<div class="col-md-6">
					<div class="bg1">
						<img src="/webassets/2021/img/Reminders-bg-right.svg" alt="Automatic-Reminders-Notifications-background" class="bg-r">
						<img src="/webassets/2021/img/reminders.svg"  alt="Automatic-Reminders-Notifications" class="img-r">
					</div>
				</div>
			</div>
		</div>
	...
	<section class="class-booking">
		<div class="container-fluid" style="overflow: hidden;">
			<div class="container">
				<div class="col-md-6">
					<div class="bg2">
						<img src="/webassets/2021/img/Payment-and-invoicing-bg.svg" alt="Schedule-Class-bookings-Group-bookings-coaching-Background" class="bg-c">
						<img src="/webassets/2021/img/yoga.svg" alt="Schedule-Class-bookings-Group-bookings-coaching" class="img-c">
					</div>
				</div>
				<div class="col-md-6">
