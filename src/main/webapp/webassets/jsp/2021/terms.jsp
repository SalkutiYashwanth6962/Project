...
<head>
	...
	<p><b>Owner contact email:</b>  legal@picktime.com</p>
	<p>"www.picktime.com" refers to</p>
	<ul>
	...
	<h2>What the User should know at a glance</h2><ul>
	<li>www.picktime.com uses automatic renewal for Product subscriptions. Information about the a) renewal period, b) termination details and c) termination notice can be found in the relevant section of these Terms.</li>
	</ul>
	<ul>
	...
	<hr>
	<h2>TERMS OF USE</h2><p>Unless otherwise specified, the terms of use detailed in this section apply generally when using www.picktime.com.</p>
	...
	<p>By using www.picktime.com, Users confirm to meet the following requirements:</p>
	<ul>
	...
	<li><p>User's access or use of www.picktime.com may cause injury to the Owner, other Users or third parties; and/or</p></li>
	<li><p>the use of www.picktime.com by the User may cause violation of law or regulations; and/or</p></li>
	...
	<h3>Content on www.picktime.com</h3>
	<p>Unless where otherwise specified or clearly recognizable, all content available on www.picktime.com is owned or provided by the Owner or its licensors.</p>
	
	<p>The Owner undertakes its utmost effort to ensure that the content provided on www.picktime.com infringes no applicable legal provisions or third-party rights. However, it may not always be possible to achieve such a result.<br>
	...
	<h4>Rights regarding content on www.picktime.com - “Some-rights-reserved”</h4>
	<p>Unless where explicitly stated, the following does not apply to any content provided by third-party licensors and available on www.picktime.com, such as for instance third-party trademarks, logos, images or the like:</p>
	...
	<h4>Rights regarding content provided by Users</h4>
	<p>Users acknowledge and accept that by providing their own content on www.picktime.com they grant the Owner a non-exclusive, fully paid-up and royalty-free license to process such content solely for the operation and maintenance of www.picktime.com as contractually required.</p>
	
	<p>To the extent permitted by applicable law, Users waive any moral rights in connection with content they provide to www.picktime.com.</p>
	<p>Users acknowledge, accept and confirm that all content they provide through www.picktime.com is provided subject to the same general conditions set forth for content on www.picktime.com.</p>
	<h4>Liability for provided content</h4>
	<p>Users are solely liable for any content they upload, post, share, or provide through www.picktime.com. Users acknowledge and accept that <strong>the Owner does not filter or moderate such content</strong>.</p>
	
	<p>However, the Owner reserves the right to remove, delete, block or rectify such content at its own discretion and to, without prior notice, deny the uploading User access to www.picktime.com:</p>
	...
	<li>where the Owner is made aware that the content, while being accessible via www.picktime.com, may represent a risk for Users, third parties and/or the availability of the Service.</li>
	</ul>
	...
	<p>Therefore, the Owner reserves the right to take any appropriate measure to protect its legitimate interests including by denying Users access to www.picktime.com or the Service, terminating contracts, reporting any misconduct performed through www.picktime.com or the Service to the competent authorities – such as judicial or administrative authorities - whenever Users engage or are suspected to engage in any of the following activities:</p>
	...
	<h2>TERMS AND CONDITIONS OF SALE</h2><h3>Paid Products</h3>
	<p>Some of the Products provided on www.picktime.com, as part of the Service, are provided on the basis of payment.</p>
	...
	<p>Prices on www.picktime.com are displayed:</p>
	<ul>
	    ...
	    <div class="panel panel-default">
	      <div class="panel-heading">
	        <h4 class="panel-title">
	          <a data-toggle="collapse" data-parent="#Definitions" href="#collapse2">Definitions and legal references</a>
	        </h4>
	      </div>
	      <div id="collapse2" class="panel-collapse collapse">
	        <div class="panel-body">
	         <h4>www.picktime.com (or this Application)</h4>
				...
				<h4>Owner (or We)</h4>
				<p>Indicates the natural person(s) or legal entity that provides www.picktime.com and/or the Service to Users.</p>
				<h4>Product</h4>
				<p>A good or service available for purchase through www.picktime.com, such as e.g. physical goods, digital files, software, booking services etc.</p>
				
				<p>The sale of Products may be part of the Service.</p>
				<h4>Service</h4>
				<p>The service provided by www.picktime.com as described in these Terms and on www.picktime.com.</p>
				<h4>Terms</h4>
				<p>All provisions applicable to the use of www.picktime.com and/or the Service as described in this document, including any other related documents or agreements, and as updated from time to time.</p>
				<h4>User (or You)</h4>
				<p>Indicates any natural person or legal entity using www.picktime.com.</p>
				<h4>Consumer</h4>
