		...
		<div class="row">
			...
			<div class="col-sm-10">
				<section class="terms-and-conditions">
					...
					<h3>GENERAL</h3>
					<p><b>PICKTIME INC, </b>A Texas incorporated Company having its office at 8121 Bee Caves Road, #200, Austin, Texas-78746,United States of America, hereinafter referred to as the “Company” (where such expression shall unless repugnant to the context thereof, be deemed to include its representatives, administrators, permitted successors and assigns.) The creator of this Terms of Service ensures steady commitment to your privacy with regard to the protection of your invaluable information. </p>
					...
					<h3>SUBSCRIPTION PLANS</h3>
				   	<ul>
					   	...
					   	<li>Any steps taken from choosing a subscription plan or upgrading the current subscription plan.
					   	</li>
					   	<p>The purchasing process includes these steps:
					   	</p>
					...
					<p>In order to maintain subscriptions, Users must pay the required recurring fee in a timely </p>
					<p>manner. Failure to do so may cause service interruptions.
					</p>
					...
					<h3>PAYMENT</h3>
					<p style="text-decoration: underline;">Charges</p>
					<ul>
					...
					<li>A. For example, do not copy or distribute (except through the available sharing functionality) the posts or other content of others without their permission, which they may give by posting under a Creative Commons license;
					</li>
					<li>B. Violate the intellectual property or other rights of the Platform, including, without limitation: 
					</li>
					<li>C. Copying or distributing any content generated by the Platform or other materials or
					</li>
					<li>D. Copying or distributing our technology, unless it is released under open source licenses;
					</li>
					<li>E. Using the name of the Company or its logos in any business name, email, or the name of the platform and its associated logos and trademarks;
					</li>
					<li>F. Post anything that contains software viruses, worms, or any other harmful code;
					</li>
					...
					<p>d.Contact Us: If you have any questions about this Agreement, the practices of the Platform, or your experience with the Service, you can contact us at legal@picktime.com .
					</p>
